...
const Profile = () => {
  ...
  const [detailedAddress, setDetailedAddress] = useState(
    user.user.address.detailed_address
  );
  ...
  const [buildingNo, setBuildingNo] = useState(user.user.address.building_no);
  const [apartmentNo, setApartmentNo] = useState(
    user.user.address.apartment_no
  );
  const [floorNo, setfloorNo] = useState(user.user.address.floor_no);
